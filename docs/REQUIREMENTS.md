...
OpenNekaise gives you the core functionality without that mess.
...
- Custom `opennekaise` MCP server (inside container) provides scheduling tools
...
**OpenNekaise** - A reference to Clawdbot (now OpenClaw).
