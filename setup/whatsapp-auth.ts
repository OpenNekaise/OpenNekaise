...
<html><head><title>OpenNekaise - WhatsApp Auth</title>
...
<script>
  var startKey = 'opennekaise_qr_start';
...
<html><head><title>OpenNekaise - Connected!</title>
<style>
...
<script>localStorage.removeItem('opennekaise_qr_start');</script>
</body></html>`;
